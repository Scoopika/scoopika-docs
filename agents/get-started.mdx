...
If you want to add a route to your API that can handle everything related to Scoopika, and then be able to run the agents on the client-side, you can check the [Scoopika for the web guide](/guides/scoopika-for-the-web).
...
Then initializing a Scoopika instance, the agent, and running it:
...
**Further Exploration**: For comprehensive server-side documentation, refer to the  [full documentation](/packages/ts/scoopika).
