...
meaning past conversations are forgotten. 
...
Once your history store is created, You just need to add its ID to your scoopika instance on the server-side setup:
...
By providing the history store ID during Scoopika instance initialization,
