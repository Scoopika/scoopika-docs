...
The `addTool` method allows you to equip your agents with the capabilities of external tools. This can significantly enhance your agent's functionality by enabling it to interact with external data sources or services. Refer to the [Tools](/tools) page for more information on the concept of tools within Scoopika.
