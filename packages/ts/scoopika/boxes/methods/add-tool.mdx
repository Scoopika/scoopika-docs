...
Allows you to equip a specific agent under a box with an external tool that the agent can call based on the context. [What are tools](/tools)
...
box.addTool<ToolInputs>("AGENT_ID", toolFunc, toolSchema);
```
</ResponseExample>
